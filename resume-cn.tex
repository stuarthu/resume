...
\begin{ressection}{工作经历}
	...
	\begin{ressubsec}{七牛云}{上海，浦东软件园}{技术专家: 2018.4 -- 至今}
		\ressubitem{富媒体部门私有云负责人，带领团队实现客户需求并交付给客户。}
	\end{ressubsec}
...
\begin{ressection}{技能}
	...
	\begin{reslist}{研发能力:}
		\ressubitem{分布式对象存储系统专家，在该领域拥有多年的架构、开发和部署经验，解决生产环境的问题。}
		\ressubitem{熟悉软件开发流程。}
...
\begin{ressection}{其他}
	...
	\begin{reslist}{开源贡献:}
		\ressubitem{为Rocksdb等多个开源项目贡献过代码}
	\end{reslist}

	\begin{reslist}{写作出版:}
		\ressubitem{《分布式对象存储——原理、架构及Go语言实现》，人民邮电出版社，ISBN：9787115480552}
	\end{reslist}

	\begin{reslist}{技术翻译:}
		\ressubitem{《JavaScript面向对象精要》}
		\ressubitem{《Python和HDF5大数据应用》}
		\ressubitem{《Python高性能编程》}
	\end{reslist}
