...
\begin{ressection}{工作经历}
	...
	\begin{ressubsec}{EMC}{上海，创智天地}{资深软件工程师: 2014.2 -- 至今}
						\ressubitem{Trogdor开发团队Leader，管理项目进度，安排团队工作，负责新需求的设计开发，评审成员代码，调查并处理生产环境中发生的各种问题。}
						\ressubitem{Catalog开发团队Leader，计划项目里程碑，安排团队工作，负责部分Cassandra数据库设计，负责VP架构设计，负责部分模块设计开发，评审成员代码。}
	\end{ressubsec}
	...
	\begin{ressubsec}{SAP Labs China}{上海，张江}{高级软件工程师: 2007.9 -- 2013.1}
		\ressubitem{负责SAP Business One产品开发。本人所在Inventory Team负责库存模块的开发与维护。}
						\ressubitem{MSSQL的性能调优，熟悉不同业务环境下对数据库各种特殊的性能要求，能够轻松查找SQL以及数据库存储过程中的性能弱点并加以修正。}
